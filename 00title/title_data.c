// Data tables for title screen: sin/cos table for affine transforms

#include "../gba/gba.h"

// sin_cos_table: 256 sin entries + 64 cos entries = 320 s16
// sin_cos_table[a] = sin(a * 360/256) * 256 (fixed-point 8.8)
// cos(a) = sin_cos_table[a + 64] = sin(a + 90°)
const s16 sin_cos_table[256 + 64] ALIGNED(4) = {
